...
/**
 * Native splash (statik) kapanır kapanmaz devreye giren, marka görseliyle
 * (splash-icon.png — logomuzdaki S harfi) devam eden kısa bir giriş
 * animasyonu — sıçrayarak büyüyen amblem + genişleyip kaybolan floodlight
 * halkası, sonra tüm ekran solarak asıl uygulamayı açığa çıkarır.
 * Bkz. BACKLOG.md #22.
 */

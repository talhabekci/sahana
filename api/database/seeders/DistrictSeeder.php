...
{
    /** @var array<int, array<int, string>> il plaka kodu => ilçe adları */
    private const DISTRICTS = [
        ...
        8 => ['Ardanuç', 'Arhavi', 'Borçka', 'Hopa', 'Merkez', 'Murgul', 'Şavşat', 'Yusufeli'],
        ...
        55 => ['Alaçam', 'Asarcık', 'Atakum', 'Ayvacık', 'Bafra', 'Canik', 'Çarşamba', 'Havza', 'İlkadım', 'Kavak', 'Ladik', 'Salıpazarı', 'Tekkeköy', 'Terme', 'Vezirköprü', 'Yakakent', '19 mayıs'],
    ...
    public function run(): void
    {
        ...
        foreach (self::DISTRICTS as $CityId => $Names) {
            foreach ($Names as $Name) {
                $Rows[] = ['city_id' => $CityId, 'name' => $Name];
            }
        }

        foreach (array_chunk($Rows, 200) as $Chunk) {
            DB::table('districts')->upsert($Chunk, ['city_id', 'name']);
        }
    }
}

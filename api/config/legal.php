...
// Mobil uygulamadaki mobile/src/features/settings/legalContent.ts ile
// aynı içerik (App Store/Play Store gizlilik politikası URL zorunluluğu
// + landing sayfası footer linkleri için web'de de servis ediliyor).
// İkisi ayrı kod tabanında (PHP/TS) olduğu için elle senkron tutulmalı.
return [
    'documents' => [
        'privacy' => [
            'title' => 'Gizlilik Politikası',
            'updated_at' => '14 Temmuz 2026',
            'sections' => [
                [
